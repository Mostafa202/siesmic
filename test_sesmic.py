# -*- coding: utf-8 -*-
"""
Created on Sun Jul 17 21:37:01 2022
...
def test_sesimc(TEST_SPLIT,N_EVALUATE,config):
    
    # get the model and it's setup
...
result=test_sesimc(TEST_SPLIT,N_EVALUATE,config)            
